...
![image_d497113754baca605f005e2b5cd5d051.png](/assets/posts/47372/image_d497113754baca605f005e2b5cd5d051.png)
    ...
    if (searchQuery) {
      try {
        ...
        await sendMessage(
          recvId,
          message,
          data.items && data.items.length > 0 ? 'html' : 'text',
          recvType,
        )
      } catch (e) {}
    }
...
在`域和路由`中点击添加选择路由，区域选任意一个域名，然后输入域名+/_ （例如yhchat.aaa.com/_）

然后去dns解析中为这个域名添加一个记录，可以cname到dns-cf.butlanys.de（相比较于cf原来分配的IP，此优选IP可以提升响应速度）
...
- 群组![image_373ed3e31f7c87e894c1b1d54e2d2600.png](/assets/posts/47372/image_373ed3e31f7c87e894c1b1d54e2d2600.png)
- 私聊![image_0befb1605bdfe0631ee13f4155d9e81c.png](/assets/posts/47372/image_0befb1605bdfe0631ee13f4155d9e81c.png)
