...
比如说[aplayer播放器对接alist | butlanys的博客](https://blog.butlanys.de/posts/51355/)播放等 ~~（此文章正在写，稍安毋操）~~
...
在\_config.butterfly.yml文件的inject—head中加入
...
回到\_config.butterfly.yml中，在bottom字段添加
...
[data-theme='dark'] .aplayer .aplayer-info .aplayer-controller .aplayer-time path {
  fill: #d4d4d4;
}
